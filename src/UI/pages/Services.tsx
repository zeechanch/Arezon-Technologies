...
export function Services() {
  return (
    <div id="services" className="container grid">
      <div className=" flex flex-col gap-2  md:justify-center items-start md:items-center text-center pt-12">
        ...
        <h1 className="text-left text-4xl md:text-5xl font-bold">
          Power Innovation with Scalable Digital Solutions
        </h1>
        <p className="text-center w-full sm:w-1/2">
          Whether you’re a startup aiming to launch fast or an established business ready to scale, Arezon Technologies provides end-to-end development services to help you grow, stay ahead, and stand out.
        </p>
      </div>
